  ...
  return (
    <>
      <div className="w-full h-screen p-10 flex  items-center flex-col relative ">
        ...
        <button className=" bg-black text-white p-2  mt-4" onClick={showAddForm}>
          Add
        </button>
      </div>
      ...
      >
        ...
        <span className="absolute -top-10 -right-9 text-4xl  text-white cursor-pointer" onClick={cancelForm}><RxCross1 /></span>
          <textarea
            ...
            value={todo}
          />
          <button className="bg-black p-2 mt-5 text-white" onClick={addTodo}>Add</button>
        </div>
      </div>
    </>
  );
